...
function setupSignalHandlers() {
  ...
  process.on('newListener', function(type, listener) {
    if (isSignal(type) &&
      ...
      if(type === 'SIGINT') {
          //TODO: this is probably a little over complicated -- should unify this and ttdSigIntHandler setup below
          wrap.onsignal = function () {; }; //ENABLE_TTD ttdSigIntHandler will emit event after it runs
      }
      else {
